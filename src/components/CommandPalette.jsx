...
export default function CommandPalette() {
  ...
  return (
    ...
    >
      ...
      {/* Modal Box with Apple Specular Glass & Multi-Stop Shadows */}
      <div className="relative w-full max-w-xl apple-glass text-ink-primary border border-cream-border/90 rounded-2xl shadow-2xl overflow-hidden flex flex-col z-10 animate-fadeIn">
        {/* Search Input Bar */}
