// ============================================================
// SHARED ICONS — inline SVG placeholders, migrated verbatim from code.html.
// ============================================================

export const CameraIcon = (
  <svg aria-hidden="true" className="w-6 h-6 stroke-current stroke-[1.5] fill-none" viewBox="0 0 24 24">
...
export const PersonIcon = (
  <svg aria-hidden="true" className="w-6 h-6 stroke-current fill-none stroke-[1.5]" viewBox="0 0 24 24">
...
// Coverflow card icons (one per showcase category)
