...
export default function Testimonials() {
  return (
    <section className="border-t border-cream-border py-20 sm:py-28 max-w-7xl mx-auto px-6 sm:px-10 scroll-mt-20" id="testimonials">
      <div className="mb-12">
        <span className="text-[11px] sm:text-xs font-semibold tracking-[0.15em] uppercase text-ink-muted block mb-3">What People Say</span>
        ...
        {testimonials.map((t) => (
          <div key={t.name} className="bg-white border border-cream-border rounded-xl p-6 sm:p-8 flex flex-col justify-between">
            ...
            <div>
              ...
              <span className="text-[11px] font-mono uppercase tracking-wider text-slate-400">{t.reference}</span>
            </div>
          </div>
        ))}
      </div>
