...
export default function About() {
  return (
    <section className="border-t border-cream-border py-20 sm:py-32 max-w-7xl mx-auto px-6 sm:px-10 scroll-mt-20" id="about">
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20 items-start">
          ...
          <div className="sticky top-28">
            <div className="bg-white border border-cream-border rounded-xl overflow-hidden p-2">
              <div aria-label="Foto dokumentasi BTS Hauzan Naufal di Lumajang" className="aspect-[3/4] w-full overflow-hidden rounded-lg bg-slate-100" role="img">
                <div className="w-full h-full bg-[#f4f4f0] flex flex-col items-center justify-center p-6 text-center border border-dashed border-[#d1d1ca] rounded-lg relative overflow-hidden select-none">
                  ...
                  <span className="text-[11px] font-mono uppercase tracking-[0.14em] text-slate-500">3:4 Portrait · Visual Direction</span>
                </div>
              </div>
            </div>
        ...
        <div className="lg:col-span-7 flex flex-col justify-center">
          <div className="mb-4">
            <span className="text-[11px] sm:text-xs font-semibold tracking-[0.15em] uppercase text-ink-muted">Profil &amp; Dedikasi Visual</span>
          </div>
          ...
          <div className="pt-2 flex flex-col sm:flex-row sm:items-center gap-4 flex-wrap">
            <a className="inline-flex items-center justify-center px-5 py-2.5 rounded-full bg-[#0f172a] text-[#f8fafc] text-sm font-medium hover:bg-slate-800 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-slate-900/20 focus-visible:ring-offset-2" href="mailto:hauzannaufal2008@gmail.com">
